...
tms_opt56_HH.pathfem = 'fornixIXI56_HHH1/'
### Select coil model
tms_opt56_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt56_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI56_HH')
### pardiso solver
...
### Select output folder
tms_opt57_HH.pathfem = 'fornixIXI57_HHH1/'
### Select coil model
tms_opt57_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt57_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI57_HH')
### pardiso solver
...
### Select output folder
tms_opt59_HH.pathfem = 'fornixIXI59_HHH1/'
### Select coil model
tms_opt59_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt59_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI59_HH')
### pardiso solver
...
### Select output folder
tms_opt67_HH.pathfem = 'fornixIXI67_HHH1/'
### Select coil model
tms_opt67_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt67_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI67_HH')
### pardiso solver
...
### Select output folder
tms_opt72_HH.pathfem = 'fornixIXI72_HHH1/'
### Select coil model
tms_opt72_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt72_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI72_HH')
### pardiso solver
...
### Select output folder
tms_opt79_HH.pathfem = 'fornixIXI79_HHH1/'
### Select coil model
tms_opt79_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt79_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI79_HH')
### pardiso solver
...
### Select output folder
tms_opt80_HH.pathfem = 'fornixIXI80_HHH1/'
### Select coil model
tms_opt80_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt80_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI80_HH')
### pardiso solver
...
### Select output folder
tms_opt83_HH.pathfem = 'fornixIXI83_HHH1/'
### Select coil model
tms_opt83_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt83_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI83_HH')
### pardiso solver
...
### Select output folder
tms_opt92_HH.pathfem = 'fornixIXI92_HHH1/'
### Select coil model
tms_opt92_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt92_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI92_HH')
### pardiso solver
...
### Select output folder
tms_opt93_HH.pathfem = 'fornixIXI93_HHH1/'
### Select coil model
tms_opt93_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt93_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI93_HH')
### pardiso solver
...
### Select output folder
tms_opt94_HH.pathfem = 'fornixIXI94_HHH1/'
### Select coil model
tms_opt94_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt94_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI94_HH')
### pardiso solver
...
### Select output folder
tms_opt95_HH.pathfem = 'fornixIXI95_HHH1/'
### Select coil model
tms_opt95_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt95_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI95_HH')
### pardiso solver
...
### Select output folder
tms_opt96_HH.pathfem = 'fornixIXI96_HHH1/'
### Select coil model
tms_opt96_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt96_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI96_HH')
### pardiso solver
...
### Select output folder
tms_opt97_HH.pathfem = 'fornixIXI97_HHH1/'
### Select coil model
tms_opt97_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt97_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI97_HH')
### pardiso solver
...
### Select output folder
tms_opt559_HH.pathfem = 'fornixIXI559_HHH1/'
### Select coil model
tms_opt559_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt559_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI559_HH')
### pardiso solver
...
### Select output folder
tms_opt565_HH.pathfem = 'fornixIXI565_HHH1/'
### Select coil model
tms_opt565_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt565_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI565_HH')
### pardiso solver
...
### Select output folder
tms_opt566_HH.pathfem = 'fornixIXI566_HHH1/'
### Select coil model
tms_opt566_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt566_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI566_HH')
### pardiso solver
...
### Select output folder
tms_opt567_HH.pathfem = 'fornixIXI567_HHH1/'
### Select coil model
tms_opt567_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt567_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI567_HH')
### pardiso solver
...
### Select output folder
tms_opt568_HH.pathfem = 'fornixIXI568_HHH1/'
### Select coil model
tms_opt568_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt568_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI568_HH')
### pardiso solver
...
### Select output folder
tms_opt572_HH.pathfem = 'fornixIXI572_HHH1/'
### Select coil model
tms_opt572_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt572_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI572_HH')
### pardiso solver
...
### Select output folder
tms_opt575_HH.pathfem = 'fornixIXI575_HHH1/'
### Select coil model
tms_opt575_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt575_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI575_HH')
### pardiso solver
...
### Select output folder
tms_opt577_HH.pathfem = 'fornixIXI577_HHH1/'
### Select coil model
tms_opt577_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt577_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI577_HH')
### pardiso solver
...
### Select output folder
tms_opt586_HH.pathfem = 'fornixIXI586_HHH1/'
### Select coil model
tms_opt586_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt586_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI586_HH')
### pardiso solver
...
### Select output folder
tms_opt598_HH.pathfem = 'fornixIXI598_HHH1/'
### Select coil model
tms_opt598_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt598_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI598_HH')
### pardiso solver
...
### Select output folder
tms_opt599_HH.pathfem = 'fornixIXI599_HHH1/'
### Select coil model
tms_opt599_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt599_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI599_HH')
### pardiso solver
...
### Select output folder
tms_opt600_HH.pathfem = 'fornixIXI600_HHH1/'
### Select coil model
tms_opt600_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt600_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI600_HH')
### pardiso solver
...
### Select output folder
tms_opt601_HH.pathfem = 'fornixIXI601_HHH1/'
### Select coil model
tms_opt601_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt601_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI601_HH')
### pardiso solver
...
### Select output folder
tms_opt603_HH.pathfem = 'fornixIXI603_HHH1/'
### Select coil model
tms_opt603_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt603_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI603_HH')
### pardiso solver
...
### Select output folder
tms_opt605_HH.pathfem = 'fornixIXI605_HHH1/'
### Select coil model
tms_opt605_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt605_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI605_HH')
### pardiso solver
...
### Select output folder
tms_opt606_HH.pathfem = 'fornixIXI606_HHH1/'
### Select coil model
tms_opt606_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt606_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI606_HH')
### pardiso solver
...
### Select output folder
tms_opt608_HH.pathfem = 'fornixIXI608_HHH1/'
### Select coil model
tms_opt608_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt608_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI608_HH')
### pardiso solver
...
### Select output folder
tms_opt609_HH.pathfem = 'fornixIXI609_HHH1/'
### Select coil model
tms_opt609_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt609_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI609_HH')
### pardiso solver
...
## Select output folder
tms_opt610_HH.pathfem = 'fornixIXI610_HHH1/'
## Select coil model
tms_opt610_HH.fnamecoil = 'No9_H1.nii.gz'
## Select a target for the optimization
tms_opt610_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI610_HH')
## pardiso solver
...
## Select output folder
tms_opt611_HH.pathfem = 'fornixIXI611_HHH1/'
## Select coil model
tms_opt611_HH.fnamecoil = 'No9_H1.nii.gz'
## Select a target for the optimization
tms_opt611_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI611_HH')
## pardiso solver
...
## Select output folder
tms_opt612_HH.pathfem = 'fornixIXI612_HHH1/'
## Select coil model
tms_opt612_HH.fnamecoil = 'No9_H1.nii.gz'
## Select a target for the optimization
tms_opt612_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI612_HH')
## pardiso solver
...
## Select output folder
tms_opt613_HH.pathfem = 'fornixIXI613_HHH1/'
## Select coil model
tms_opt613_HH.fnamecoil = 'No9_H1.nii.gz'
## Select a target for the optimization
tms_opt613_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI613_HH')
## pardiso solver
...
### Select output folder
tms_opt614_HH.pathfem = 'fornixIXI614_HHH1/'
### Select coil model
tms_opt614_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt614_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI614_HH')
### pardiso solver
...
### Select output folder
tms_opt631_HH.pathfem = 'fornixIXI631_HHH1/'
### Select coil model
tms_opt631_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt631_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI631_HH')
### pardiso solver
...
### Select output folder
tms_opt632_HH.pathfem = 'fornixIXI632_HHH1/'
### Select coil model
tms_opt632_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt632_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI632_HH')
### pardiso solver
...
### Select output folder
tms_opt633_HH.pathfem = 'fornixIXI633_HHH1/'
### Select coil model
tms_opt633_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt633_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI633_HH')
### pardiso solver
...
### Select output folder
tms_opt634_HH.pathfem = 'fornixIXI634_HHH1/'
### Select coil model
tms_opt634_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt634_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI634_HH')
### pardiso solver
...
### Select output folder
tms_opt635_HH.pathfem = 'fornixIXI635_HHH1/'
### Select coil model
tms_opt635_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt635_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI635_HH')
### pardiso solver
...
### Select output folder
tms_opt636_HH.pathfem = 'fornixIXI636_HHH1/'
### Select coil model
tms_opt636_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt636_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI636_HH')
### pardiso solver
...
### Select output folder
tms_opt637_HH.pathfem = 'fornixIXI637_HHH1/'
### Select coil model
tms_opt637_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt637_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI637_HH')
### pardiso solver
...
### Select output folder
tms_opt638_HH.pathfem = 'fornixIXI638_HHH1/'
### Select coil model
tms_opt638_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt638_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI638_HH')
### pardiso solver
...
### Select output folder
tms_opt643_HH.pathfem = 'fornixIXI643_HHH1/'
### Select coil model
tms_opt643_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt643_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI643_HH')
### pardiso solver
...
### Select output folder
tms_opt646_HH.pathfem = 'fornixIXI646_HHH1/'
### Select coil model
tms_opt646_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt646_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI646_HH')
### pardiso solver
...
### Select output folder
tms_opt661_HH.pathfem = 'fornixIXI661_HHH1/'
### Select coil model
tms_opt661_HH.fnamecoil = 'No9_H1.nii.gz'
### Select a target for the optimization
tms_opt661_HH.target = mni2subject_coords([0.03, -2.98, 9.86], 'm2m_IXI661_HH')
### pardiso solver
